...
struct mdp_ccs {
	...
	__uint16_t ccs[MDP_CCS_SIZE];	/* 3x3 color coefficients */
	__uint16_t bv[MDP_BV_SIZE];	/* 1x3 bias vector */
};

struct mdp_csc {
	int id;
	__uint32_t csc_mv[9];
	__uint32_t csc_pre_bv[3];
	__uint32_t csc_post_bv[3];
	__uint32_t csc_pre_lv[6];
	__uint32_t csc_post_lv[6];
};
...
struct mdp_blit_req {
	...
	__uint32_t alpha;
	__uint32_t transp_mask;
	__uint32_t flags;
	int sharpening_strength;  /* -127 <--> 127, default 64 */
	__uint8_t color_space;
	__uint32_t fps;
};
...
struct mdp_sharp_cfg {
	...
	__uint32_t strength;
	__uint32_t edge_thr;
	__uint32_t smooth_thr;
	__uint32_t noise_thr;
};
...
struct mdp_pa_mem_col_cfg {
	__uint32_t color_adjust_p0;
	__uint32_t color_adjust_p1;
	__uint32_t hue_region;
	__uint32_t sat_region;
	__uint32_t val_region;
};
...
struct mdp_pa_v2_data {
	...
	__uint32_t flags;
	__uint32_t global_hue_adj;
	__uint32_t global_sat_adj;
	__uint32_t global_val_adj;
	__uint32_t global_cont_adj;
	struct mdp_pa_mem_col_cfg skin_cfg;
	struct mdp_pa_mem_col_cfg sky_cfg;
	struct mdp_pa_mem_col_cfg fol_cfg;
	__uint32_t six_zone_len;
	__uint32_t six_zone_thresh;
	__uint32_t *six_zone_curve_p0;
	__uint32_t *six_zone_curve_p1;
};

struct mdp_igc_lut_data {
	__uint32_t block;
	__uint32_t len, ops;
	__uint32_t *c0_c1_data;
	__uint32_t *c2_data;
};
...
struct mdp_overlay {
	...
	struct mdp_rect src_rect;
	struct mdp_rect dst_rect;
	__uint32_t z_order;	/* stage number */
	__uint32_t is_fg;		/* control alpha & transp */
	__uint32_t alpha;
	__uint32_t blend_op;
	__uint32_t transp_mask;
	__uint32_t flags;
	__uint32_t pipe_type;
	__uint32_t id;
	__uint8_t priority;
	__uint32_t user_data[6];
	__uint32_t bg_color;
	__uint8_t horz_deci;
	__uint8_t vert_deci;
...
struct mdp_misr {
	__uint32_t block_id;
	__uint32_t frame_count;
	__uint32_t crc_op_mode;
	__uint32_t crc_value[MISR_CRC_BATCH_SIZE];
};
...
struct mdp_histogram_data {
	...
	__uint32_t *c1;
	__uint32_t *c2;
	__uint32_t *extra_info;
};

struct mdp_pcc_coeff {
	__uint32_t c, r, g, b, rr, gg, bb, rg, gb, rb, rgb_0, rgb_1;
};
...
struct mdp_pgc_lut_data {
	__uint32_t block;
	__uint32_t flags;
	__uint8_t num_r_stages;
	__uint8_t num_g_stages;
	__uint8_t num_b_stages;
...
struct mdp_dither_cfg_data {
	__uint32_t block;
	__uint32_t flags;
	__uint32_t g_y_depth;
	__uint32_t r_cr_depth;
	__uint32_t b_cb_depth;
};

struct mdp_gamut_cfg_data {
	__uint32_t block;
	__uint32_t flags;
	__uint32_t gamut_first;
	__uint32_t tbl_size[MDP_GAMUT_TABLE_NUM];
	__uint16_t *r_tbl[MDP_GAMUT_TABLE_NUM];
	__uint16_t *g_tbl[MDP_GAMUT_TABLE_NUM];
	__uint16_t *b_tbl[MDP_GAMUT_TABLE_NUM];
};
...
struct mdp_calib_dcm_state {
	__uint32_t ops;
	__uint32_t dcm_state;
};

struct mdp_pp_init_data {
	__uint32_t init_request;
};
...
struct mdss_ad_init {
	__uint32_t asym_lut[33];
	__uint32_t color_corr_lut[33];
	__uint8_t i_control[2];
	__uint16_t black_lvl;
	__uint16_t white_lvl;
	__uint8_t var;
	__uint8_t limit_ampl;
	__uint8_t i_dither;
	__uint8_t slope_max;
	__uint8_t slope_min;
	__uint8_t dither_ctl;
	__uint8_t format;
	__uint8_t auto_size;
	__uint16_t frame_w;
	__uint16_t frame_h;
	...
	__uint8_t logo_h;
	__uint32_t alpha;
	__uint32_t alpha_base;
	__uint32_t bl_lin_len;
	__uint32_t bl_att_len;
	__uint32_t *bl_lin;
	__uint32_t *bl_lin_inv;
	__uint32_t *bl_att_lut;
};
...
struct mdss_ad_cfg {
	__uint32_t mode;
	__uint32_t al_calib_lut[33];
	__uint16_t backlight_min;
	__uint16_t backlight_max;
	__uint16_t backlight_scale;
	__uint16_t amb_light_min;
	__uint16_t filter[2];
	__uint16_t calib[4];
	__uint8_t strength_limit;
	__uint8_t t_filter_recursion;
	__uint16_t stab_itr;
	__uint32_t bl_ctrl_mode;
};
...
struct mdp_blend_cfg {
	__uint32_t is_premultiplied;
};

struct mdp_mixer_cfg {
	__uint32_t writeback_format;
	__uint32_t alpha;
};
...
struct mdss_hw_caps {
	...
	__uint8_t vig_pipes;
	__uint8_t dma_pipes;
	__uint8_t max_smp_cnt;
	__uint8_t smp_per_pipe;
	__uint32_t features;
};
...
struct msmfb_metadata {
	...
	union {
		...
		__uint32_t panel_frame_rate;
		__uint32_t video_info_code;
...
struct mdp_buf_sync {
	__uint32_t flags;
	__uint32_t acq_fen_fd_cnt;
	__uint32_t session_id;
	int *acq_fen_fd;
	int *rel_fen_fd;
	int *retire_fen_fd;
};
 ...
 */
struct mdp_overlay_list {
	__uint32_t num_overlays;
	struct mdp_overlay **overlay_list;
	__uint32_t flags;
	__uint32_t processed_overlays;
};

struct mdp_page_protection {
	__uint32_t page_protection;
};
